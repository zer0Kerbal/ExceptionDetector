...
tags: ExceptionDetector,adoption,ED,release-notes,kerbal,ksp,zer0Kerbal,zedK
layout: page
---
...
[![ExceptionDetector Version][MOD:shd:stat]][MOD:forum] [![KSP version][KSP:shd:stat]][KSP:url]
...
<p style="border:0.5px solid Tomato; background-color: #bada55; color: #FF0000; text-align:center">Download from <a href="https://www.curseforge.com/kerbal/ksp-mods/ExceptionDetector/files">CurseForge</a></p>
...
* Issues
  * closes #4 - ExceptionDetector 1.3.0.0-adoption `<SafetyFirst!>`
...
[MOD:issue]: https://github.com/zer0Kerbal/ExceptionDetector/issues "Issue Tracker"
[MOD:known]: https://github.com/zer0Kerbal/ExceptionDetector/wiki/Known-Issues "Known Issues"
[MOD:licns]: https://github.com/zer0Kerbal/ExceptionDetector/blob/master/LICENSE "Repo License"
...
<!-- mod -->
[MOD:shd:stat]: https://img.shields.io/badge/ExceptionDetector%20(ED)%20-v1.2.0.0--adoption-BADA55.svg?style=plastic&labelColor=darkgreen "1.3.0.0-adoption"
...
[AVCVAL:shd]: https://github.com/zer0Kerbal/ExceptionDetector/actions/workflows/AVC-VersionFileValidator.yml/badge.svg?labelColor=black&style=plastic "AVC-Valid - thank you to DasSkelett"
